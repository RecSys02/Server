...
public class PlanAiService {
    ...
    public Map<String, List<PlaceItem>> createSchedule(List<Long> placeIds, Integer duration) {

        String prompt = makePromptFromPlaces(placeIds, duration);
    ...
    public String makePromptFromPlaces(List<Long> placeIds, Integer duration) {
        ...
        int size = Math.min(places.size(), placeIds.size());
